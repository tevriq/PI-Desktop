...
test("invalid retry writes stay rejected at both boundaries", () => {
  // `undefined` is how the JSON wire format spells "absent" and both
  // validators tolerate it for that reason (see turn-process.test.mjs).
  for (const value of [null, "yes", 0, {}]) {
